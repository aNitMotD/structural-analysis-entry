...
- Interpretation boundary: [INTERPRETATION-BOUNDARIES](./INTERPRETATION-BOUNDARIES.md)

The remaining documents in this repository
are intended to be read
only after the boundary above
has been reviewed.
...
- 해석 경계: [INTERPRETATION-BOUNDARIES](./INTERPRETATION-BOUNDARIES.md)
